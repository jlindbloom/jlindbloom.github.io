...
publications_data = yaml.safe_load(open("publications.yaml"))
...
author_urls = {
    "Dylan Green": "https://sites.google.com/view/DylanGreen",
    "Anne Gelb": "https://math.dartmouth.edu/~annegelb/",
    "Jan Glaubitz": "https://www.janglaubitz.com/",
    "Mirjeta Pasha": "https://sites.google.com/view/mirjeta-pasha/home",
    "Youssef Marzouk": "https://aeroastro.mit.edu/people/youssef-m-marzouk/",
}
...
for _, data in publications_data.items():
...
```{python}
#| output: asis
for pub_str in pub_strs["publications"]:
    display(
        HTML(
            pub_str
        )
